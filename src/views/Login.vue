<template>
  <div>
    <svg 
      ...
      fill="none"
      viewBox="0 100 584.877 400"
    >
      <g>
        <path
          d="M566.395,135.219H18.477c-5.006,0-9.339,1.824-12.993,5.484C1.824,144.362,0,148.689,0,153.695v277.487
        ...
        />
        <path
          d="M306.471,268.127v-39.26c4.309,3.207,7.045,7.993,8.312,14.498c0.318,1.592,1.879,2.632,3.402,2.448l30.307-3.953
    ...
    <h1 class="title">Welcome to Expense Vue</h1>
    <div class="container">
      <div class="text-input">
        <input
          ...
          v-model="login.email"
        />
        <label for="email-input" class="label-name">
      ...
      <div class="text-input">
        ...
        />
        <label for="password-input" class="label-name">
...
<style scoped>
#logo {
  animation: fill-animation 1s ease forwards 2s;
  overflow: visible;
  stroke: hsl(151, 69%, 26%);
  z-index: -1;
  width: 50vw;
}
#logo path {
  ...
  animation: linear-animation 2s ease forwards;
}
